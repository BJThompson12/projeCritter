import { FaceSmileIcon, CheckIcon, TrashIcon,FaceFrownIcon, ArrowUpCircleIcon } from '@heroicons/react/24/solid';
//hardcoded html
const CompletedProjects= () => {
    const projects = [
      ...
      return (
        ...
        <table className="w-2/3 divide-y divide-indigo-500">
          <thead className="bg-indigo-50">
            <tr>
              <th className="py-3 px-6 text-left bg-slte text-indigo-500 w-1/4">Project Status</th>
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {projects.map((project) => (
              <tr key={project.id}>
                ...
                <td className="py-4 px-6">
                  <div className="flex">
                    <ArrowUpCircleIcon className="h-6 w-6 text-indigo-800 cursor-pointer" />
